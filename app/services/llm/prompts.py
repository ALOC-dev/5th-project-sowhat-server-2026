...
<success 판별 규칙>
- 기사 내용이 다음 조건 중 하나 이상 만족할 시 'success' 값은 true이다. 
    ...
    4. 과학기술, AI, IT, 환경, 에너지 등 사회적 변화와 관련된 내용을 다룬다.
    5. 전국적 규모의 재난, 감염병, 대형 사고 등 많은 사람에게 영향을 줄 수 있는 사건을 다룬다.
    6. 향후 상황 변화나 후속 조치가 예상되는 지속적인 이슈를 다룬다.
- 위 조건을 만족하지 못할 시 {{'success': false, 'category': '', 'summary': '', 'keyword': []}}를 반환한다.
- 독자의 다수에게 영향을 주는지를 기준으로 판단한다.
</success 판별 규칙>
